# fine-tune the frame-level speech model on the larger multi-speaker spoken-math dataset

out_dir = "out-audio-math-multivoice-frame-v3"
eval_interval = 5000
...
wandb_run_name = "audio_math_multivoice_frame_v3"
tensorboard_log = True
tensorboard_run_name = "audio_math_multivoice_frame_v3"
...
init_from = "resume"
resume_ckpt_path = "out-audio-librispeech-frame-v3/ckpt.pt"
